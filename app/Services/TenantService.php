...
class TenantService
{
     ...
     * @param  string|int|array<string, mixed>|null  $default  Valore di default se la chiave non esiste
     * @return float|int|string|array<string, mixed>|null Valore risolto della configurazione
     */
