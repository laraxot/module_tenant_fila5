...
> **Module/Theme:** Tenant
> **Scope:** Tenant-specific knowledge only
> **Created:** 2026-04-15
> **Based on:** Karpathy's LLM Wiki pattern

## Role

You are the **Tenant Wiki Maintainer**. Your job is to:
...
- Concept is unique to Tenant
- Pattern is Tenant-specific
- Decision only affects Tenant
