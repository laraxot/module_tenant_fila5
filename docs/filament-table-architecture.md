...
module: Tenant
updated: 2026-09-01
qmd: "tabella filament resource table class getTableFilters XotBaseResourceTable HasXotTable list page tenant"
---
...
```php
namespace Modules\Tenant\Filament\Resources\FooResource\Tables;
