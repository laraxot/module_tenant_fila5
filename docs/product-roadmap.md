# Tenant - Product Roadmap

> Documento vivente. Modulo.
> Maturita' stimata: 69% implementato, 31% gap residuo.

## Visione di avanzamento

Questo roadmap traduce il PRD in sequenza di rilascio per **Tenant**, che nel progetto copre: multi-tenancy, isolamento e bootstrap tenant.
