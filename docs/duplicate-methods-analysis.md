...
Questo documento identifica i metodi duplicati nel modulo **Tenant** che potrebbero beneficiare di refactoring.
...
**Tipo Refactoring**: `Interface` | **Complessità**: 🟢 Low | **Confidenza**: ⚠️ 66%

**Trovato in  file3 file**:

- `TransArrayAction::trans` - [Modules/Lang/app/Actions/TransArrayAction.php:44](Modules/Lang/app/Actions/TransArrayAction.php) (Modulo: Lang)
- `TransCollectionAction::trans` - [Modules/Lang/app/Actions/TransCollectionAction.php:43](Modules/Lang/app/Actions/TransCollectionAction.php) (Modulo: Lang)
- `TenantService::trans` - [Modules/Tenant/app/Services/TenantService.php:347](Modules/Tenant/app/Services/TenantService.php)
...
### 2. Metodo: `getJsonFile`

**Tipo Refactoring**: `Pattern` | **Complessità**: 🔴 High | **Confidenza**: ⚠️ 50%

**Trovato in  file2 file**:

- `Comune::getJsonFile` - [Modules/Geo/app/Models/Comune.php:112](Modules/Geo/app/Models/Comune.php) (Modulo: Geo)
- `TestSushiModel::getJsonFile` - [Modules/Tenant/app/Models/TestSushiModel.php:71](Modules/Tenant/app/Models/TestSushiModel.php)
...
- `TenantService::getName` - [Modules/Tenant/app/Services/TenantService.php:32](Modules/Tenant/app/Services/TenantService.php)
- `BaseUser::getName` - [Modules/User/app/Models/BaseUser.php:116](Modules/User/app/Models/BaseUser.php) (Modulo: User)
...
- `Domain::getRows` - [Modules/Tenant/app/Models/Domain.php:41](Modules/Tenant/app/Models/Domain.php)
- `TestSushiModel::getRows` - [Modules/Tenant/app/Models/TestSushiModel.php:98](Modules/Tenant/app/Models/TestSushiModel.php)
...
- `BaseModel::casts` - [Modules/Tenant/app/Models/BaseModel.php:61](Modules/Tenant/app/Models/BaseModel.php)
- `Tenant::casts` - [Modules/Tenant/app/Models/Tenant.php:93](Modules/Tenant/app/Models/Tenant.php)
- `TestSushiModel::casts` - [Modules/Tenant/app/Models/TestSushiModel.php:127](Modules/Tenant/app/Models/TestSushiModel.php)
...
- `TenantService::model` - [Modules/Tenant/app/Services/TenantService.php:287](Modules/Tenant/app/Services/TenantService.php)
...
- `Tenant::users` - [Modules/Tenant/app/Models/Tenant.php:104](Modules/Tenant/app/Models/Tenant.php)
- `BaseTeam::users` - [Modules/User/app/Models/BaseTeam.php:117](Modules/User/app/Models/BaseTeam.php) (Modulo: User)
- `BaseTenant::users` - [Modules/User/app/Models/BaseTenant.php:82](Modules/User/app/Models/BaseTenant.php) (Modulo: User)
- `Permission::users` - [Modules/User/app/Models/Permission.php:42](Modules/User/app/Models/Permission.php) (Modulo: User)
- `Role::users` - [Modules/User/app/Models/Role.php:51](Modules/User/app/Models/Role.php) (Modulo: User)
- `Tenant::users` - [Modules/User/app/Models/Tenant.php:55](Modules/User/app/Models/Tenant.php) (Modulo: User)
...
- `GetTenantNameAction::execute` - [Modules/Tenant/app/Actions/GetTenantNameAction.php:23](Modules/Tenant/app/Actions/GetTenantNameAction.php)
