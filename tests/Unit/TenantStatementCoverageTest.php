...
<<<<<<< .merge_file_yZkV2e
        Assert::assertSame([], $model->loadExistingData());
=======
        // Fresh instance: loadExistingData() must tolerate non-array JSON content that getSushiRows() rejects.
        $nullContentModel = new SushiToJsonCoverageModel();
        Assert::assertSame($jsonPath, $nullContentModel->getJsonFile());
        Assert::assertSame([], $nullContentModel->loadExistingData());
>>>>>>> .merge_file_bJIrGX
