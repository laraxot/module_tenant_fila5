...
describe('SushiToJson integration traits', function (): void {
    ...
    test('creates json file with tenant isolation', function (): void {
        ...
        Assert::assertSame($this->tenantModel()->id, $savedData['1']['tenant_id']);
    });
    ...
    test('handles complex data structures', function (): void {
        ...
        Assert::assertSame('Complex Item', $rows['1']['name']);
    ...
    test('handles unicode and special characters', function (): void {
        ...
        Assert::assertArrayHasKey('1', $rows);
        Assert::assertSame('Item con caratteri speciali: à, è, ì, ò, ù', $rows['1']['name']);
        Assert::assertSame('Descrizione con emoji 🚀 e simboli €$£¥', $rows['1']['description']);
    ...
    test('handles empty and null values', function (): void {
        ...
        Assert::assertSame('', $rows['1']['name']);
        Assert::assertNull($rows['1']['description']);
        Assert::assertSame('[]', $rows['1']['metadata']);
        // Verifica il secondo elemento
        Assert::assertSame('Valid Item', $rows['2']['name']);
        Assert::assertSame('Valid Description', $rows['2']['description']);
        Assert::assertNull($rows['2']['metadata']);
        Assert::assertSame('', $rows['2']['status']);
    });
    ...
    test('works with different tenant configurations', function (): void {
        ...
        $secondTenant = TenantFactory::new()->createOne([
            'name' => 'second-tenant',
